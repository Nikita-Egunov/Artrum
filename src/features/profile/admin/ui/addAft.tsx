...
export default function AddAft() {
  ...
  const inputSchema = z.object({
    ...
    title: z.string().min(1, { error: "Нельзя оставлять пустым" }),
    description: z.string().min(1, { error: "Нельзя оставлять пустым" }),
  });
  ...
  return (
    <>
      <form
        ...
        className="p-6 bg-primary-800/40 rounded-xl border border-primary-700 space-y-6"
      >
        ...
        <div
          className="border-2 border-dashed border-primary-600 rounded-xl p-8 text-center
