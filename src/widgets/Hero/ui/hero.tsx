    ...
    <section className="base relative border-app-dashed border-b">
      ...
      <div className="container border-app-dashed border-l border-r mx-auto text-center px-6 py-32 flex flex-col items-center justify-center min-h-[800px]">
        <div>
          ...
          <p className="text-xl max-w-2xl mx-auto mb-12">{p}</p>
          <div className="flex justify-center gap-6">
            <Link
              href={button1Url}
              className="bg-accent-300 text-white px-8 py-4 rounded-full 
            ...
            <Link
              href={button2Url}
              className="border-2 border-accent-300 text-accent-300 px-8 py-4 
